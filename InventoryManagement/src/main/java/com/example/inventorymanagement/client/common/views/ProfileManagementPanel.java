...
// todo: should be not resizable
//public class ProfileManagementPanel extends Application {
//    public void start(Stage stage) throws IOException {
//
//        Font.loadFont(getClass().getResourceAsStream("/fonts/ShareTechMono-Regular.ttf"),20);
//
//        FXMLLoader fxmlLoader = new FXMLLoader(ProfileManagementPanel.class.getResource("/com/example/inventorymanagement/client/view/profileManagement/profileManagement-view.fxml"));
